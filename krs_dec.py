...
for xd in range(10000):
	rr = random.randit
	rc = random.choice
	b = ['zh-cn;','en-us;','-id-id,','en-gb;','ru-ru;','jap-jap;','en-ca;','es-mx;','zh-tw;','ko-kr;','th-th;','en-in;','el-gr;','tr-tr;','fr-ff;','en-ez;','zh-hk;','ar-ae;','ru-ru;','zh-CN;en-US;','ff-ch;','pt-br;','nl-nl;']
	ap =[
    f'Mozilla/5.0 (Linux Andriod 8.1.0; NOKIA C30) AppleWebKit/537.36 (KHTML, like Gecko) Version/11 Chrome/ {str(rr(75,103))}.0.{str(rr(3500,4900))}. {str(rr(100,200))} Mobile Safari/537.36'
    f'Mozilla/5.0 (Linux Andriod 8.1.0; NOKIA C30) AppleWebKit/537.36 (KHTML, like Gecko) Version/11 Chrome/ {str(rr(100,200))} Mobile Safari/537.36'
    f'Mozilla/5.0 (Linux; Andriod 8.1.0; NOKIA C30p Build/O11019; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/11 Chrome/{str(rr(75, 103))}.0.{str(rr(3500,4900))}.{str(rr(100,220))} Mobile Safari/537.36[FB_IAB/FBAV/ {str(rr(200,400))}.0.0.{str(rr(1,9))}. {str(rr(100,200))};]']
    f'Mozilla/5.0 (Linux; Andriod 8.1.0; NOKIA C30p Build/O11019; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/11 Chrome/{str(rr(75, 103))}.0.{str(rr(3500,4900))}.{str(rr(100,220))} Mobile Safari/537.36[FBAN/EMA;FBLC/{str(rc(b))};FBAV/ {str(rr(200,400))}.0.0.{str(rr(1,9))}. {str(rr(100,200))};]']
